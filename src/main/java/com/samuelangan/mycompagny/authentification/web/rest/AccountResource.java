...
import com.samuelangan.mycompagny.authentification.service.dto.PasswordChangeDTO;
import com.samuelangan.mycompagny.authentification.web.rest.errors.EmailAlreadyUsedException;
import com.samuelangan.mycompagny.authentification.web.rest.errors.InvalidPasswordException;
import com.samuelangan.mycompagny.authentification.web.rest.errors.LoginAlreadyUsedException;
import com.samuelangan.mycompagny.authentification.web.rest.vm.KeyAndPasswordVM;
import com.samuelangan.mycompagny.authentification.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        adminUsers
            .stream()
            .forEach(adminUser -> {
                mailService.sendActivationRequestEmail(adminUser, user);
            });
    }
